// Vercel Serverless Function - Full Express.js App
...
// CORS configuration - Allow Vercel frontend deployments
const corsOptions = {
...
app.get('/', (req, res) => {
    res.json({
        success: true,
        message: 'Thrive Backend API v1.0',
...
// TypeORM test routes
app.use('/api/test/typeorm', require('../src/routes/test-typeorm.routes'));
